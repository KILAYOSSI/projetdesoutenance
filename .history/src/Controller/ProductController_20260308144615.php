...
class ProductController extends AbstractController
{
     ...
     */
    public function detail(int $id, EntityManagerInterface $entityManager, ProduitRepository $produitRepository, CategorieRepository $categorieRepository): Response
    {
