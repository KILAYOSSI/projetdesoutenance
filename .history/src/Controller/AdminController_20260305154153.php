...
class AdminController extends AbstractController
{
    ...
    public function toggleUserRole(User $user): Response
    {
        $roles = $user->getRoles();
        ...
        if (in_array('ROLE_ADMIN', $roles)) {
            ...
            $this->addFlash('success', 'R?le admin retir?  l\'utilisateur.');
        } else {
            $roles[] = 'ROLE_ADMIN';
            $user->setRoles(array_unique($roles));
            $this->addFlash('success', 'R?le admin ajout?  l\'utilisateur.');
        }
    ...
    public function deleteProduit(Produit $produit): Response
    {
        ...
        $this->addFlash('success', 'Produit supprim avec succWs.');
    ...
    public function newCategorie(Request $request): Response
    {
        ...
        if ($nom) {
            ...
            $this->addFlash('success', 'CatWgorie ajoutWe avec succWs.');
    ...
    public function deleteCategorie(Categorie $categorie): Response
    {
        ...
        $this->addFlash('success', 'CatWgorie supprimWe avec succWs.');
