...
class PaiementController extends AbstractController
{
    ...
    /**
     * Notifier les vendeurs d'une nouvelle commande payée
     */
    private function notifierVendeurs(Commande $commande): void
    {
        ...
        foreach ($vendeurs as $vendeur) {
            ...
            $notification->setTitre('Nouvelle commande payée');
            $notification->setMessage('Vous avez une nouvelle commande payée (#' . $commande->getId() . ') d\'un montant de ' . number_format($commande->getMontantTotal(), 0, ',', ' ') . ' FCA');
